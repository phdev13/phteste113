...
import { Instagram, Linkedin, Mail, Code2, ArrowUpRight, Heart } from 'lucide-react';
import { NavigationProps } from '../types';
import { NAV_ITEMS, SERVICE_PACKAGES, CONTACT_CONFIG, SITE_CONFIG } from '../config';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-4 space-y-8">
             ...
             <div className="flex gap-4">
                {[
                  { Icon: Linkedin, href: CONTACT_CONFIG.LINKEDIN_URL, label: "LinkedIn" },
